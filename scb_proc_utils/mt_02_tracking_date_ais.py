...
LOG = HOME_PATH + "logs/mt_tracking_date_ais.log"
LOCK = APP_PATH + "mt_tracking_date_ais.lock"
LOG_ERROR_FILE = BASE_PATH + "logs/mt_tracking_date_ais.err"

# Configuración logging
log_error = logging.getLogger('mt_tracking_date_ais')
